...
- When certificate acquired: uncomment signtool command in release.yml
- Generate public key for auto-update signatures (future T008)
- Implement update manifest generation (future)
