...
| `notify_daily_posture_balance` | Cumulative sitting today > 2× cumulative standing | true |
| `notify_praise_halfway` | Standing time today ≥ 50% of `stand_limit_mins × sessions` | true |
...
- Unit: `notify_daily_posture_balance` fires when sitting_secs > standing_secs × 2
