...
├─ nsis/ → zntlDesk_0.1.0_x64_en-US.exe (65 MB)
└─ msi/ → zntlDesk_0.1.0_x64_en-US.msi (62 MB)
    ↓
...
1. ✅ Plan reviewed (CEO + Eng)
2. → **Commit this plan + updated CLAUDE.md**
3. → **Delegate Wave 1 (T001-T003) to subagent (worktree)**
4. → **Review + merge Wave 1**
5. → **Delegate Wave 2 (T004-T006) to subagent**
6. → **Plan T007 (GitHub Releases) separately**
