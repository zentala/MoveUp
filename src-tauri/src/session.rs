...
//
// These tests generate random sequences of inputs and verify that
// fundamental invariants always hold, regardless of input order/values.
...
mod property_tests {
    ...
    proptest! {
        #[test]
        fn prop_sitting_seconds_never_negative(readings in prop::collection::vec(750u32..1100u32, 10..100)) {
            let mut m = SessionManager::new();
        ...
        #[test]
        fn prop_standing_seconds_never_negative(readings in prop::collection::vec(1000u32..1200u32, 10..100)) {
            let mut m = SessionManager::new();
        ...
        #[test]
        fn prop_debounce_count_bounded(readings in prop::collection::vec(750u32..1100u32, 20..200)) {
            let mut m = SessionManager::new();
        ...
        #[test]
        fn prop_state_is_always_valid(readings in prop::collection::vec(0i32..2000i32, 10..100)) {
            let mut m = SessionManager::new();
            ...
            for (idx, mm) in readings.iter().enumerate() {
                ...
                // This match ensures all state variants are covered
                match m.state.state {
                    DeskState::Sitting | DeskState::Standing | DeskState::Walking | DeskState::Away => {}
                }
            }
        }
    }
