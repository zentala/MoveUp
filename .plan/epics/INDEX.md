...
| E001 | `E001-2026-03-15-app-foundation` | done | 8/12 ticked; T10 superseded by `icon_for_state_and_progress`; T09/T11 present in code; T12 (yesterday delta) not rendered today — BACKLOG |
| E002 | `E002-2026-03-16-overlay-progress-bar` | done | 10/12 ticked; T09 resolved by the `opaque` default in `overlay_renderer.rs`; T11 debug overlay line unconfirmed, low value |
...
| E004 | `E004-2026-03-20-session-alerts` | in progress | T02/T03 done; T04 alert-flow integration test never written; T05 dismiss-without-sensor still unfixed despite `DONE.md` — BACKLOG |
| E005 | `E005-2026-03-21-ux-widgets` | done | 13/13; `WelcomePopup.tsx`, `OneBarWidget.tsx` present |
| E006 | `E006-2026-03-22-session-bugs-polish` | done | 13/15; T14/T15 superseded by `ConnectionOverlay.tsx` (E009) and E008-T08 tooltips |
