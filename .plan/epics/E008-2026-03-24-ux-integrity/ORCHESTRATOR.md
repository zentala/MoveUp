...
- [x] **E008-T01** — Update UX-FLOW.md: sync with E001, add target state machine, KPI definitions
  - Blocks: all other tasks (everyone needs to read the same truth)

## Wave 1: State Machine Fix (Rust backend)
- [x] **E008-T02** — Away state: inactive → Away regardless of desk height
...
- [x] **E008-T03** — Away sessions to DB + live timeline
  ...
  - Depends on: T02
- [x] **E008-T04** — Away flow tests (~15 Rust tests)
...
- [x] **E008-T05** — KPI rename + icons on all badges
...
- [x] **E008-T06** — Overlay/popup color unification
...
- [x] **E008-T09** — NotificationService: central routing module
...
- [x] **E008-T10** — NotificationService tests
...
## Wave 4: DevEx & Docs
- [x] **E008-T11** — Process guard: restore auto-kill old desk.exe
...
- [x] **E008-T12** — Regression tests for popup standing timer
...
- [x] **E008-T13** — Final UX-FLOW.md verification
