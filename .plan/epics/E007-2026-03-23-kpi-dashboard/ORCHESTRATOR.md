# E007 ORCHESTRATOR — Timer UX + KPI Dashboard + MetricEngine
...
**E007-T01: New ProgressBar + Animation Components**
...
**E007-T02: WidgetProps + useWidgetData Extensions**
...
**E007-T03: Timer UX Integration + Cleanup**
...
- Depends on: E007-T01 (ProgressBar component), E007-T02 (new WidgetProps fields)
...
**E007-T04: SessionManager Extensions**
...
**E007-T05: HourlyBreakTracker + GapHandler**
...
- Depends on: E007-T04 (new SessionState fields)
- Conflict zone: lib.rs (only mod declarations — easy merge)

**E007-T06: MetricEngine + 4 Metrics**
...
- Depends on: E007-T04, E007-T05, E007-T06 (all Rust components ready)
...
**E007-T09: Timeline Hour Markers**
- Status: [x] DONE
- Agent: worktree
- Modifies:
...
**E007-T11: Final Integration + Coach Removal**
