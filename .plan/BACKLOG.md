...
- [x] **E014 HANDOFF.md has no `## AO` block** — waves 1-2 are unblocked but cannot be dispatched through AO until the block exists ([epics/E014-2026-09-05-supervised-release-rollback/HANDOFF.md](epics/E014-2026-09-05-supervised-release-rollback/HANDOFF.md)); write it in the E016 session using E015's block as the template. (Medium, 2) — done 2026-09-06, dispatched via AO run E014-20260906-2012.
- [ ] **[E014 — Supervised release rollback](epics/E014-2026-09-05-supervised-release-rollback/PLAN.md)** — handoff: [HANDOFF.md](epics/E014-2026-09-05-supervised-release-rollback/HANDOFF.md). Keep several installed builds with a `last-known-good` marker so a bad release can be rolled back, and let PM3 fill the gap when nothing holds the app. **Waves 1-2 done 2026-09-06** (promoted `d12412a`, see [HISTORY.md](HISTORY.md#e014--supervised-release-rollback-waves-1-2-2026-09-06)); waves 3-4 still wait on two PM3 backlog items (`int://mATX.lan/C:/code/pm3-mcp/.plan/BACKLOG.md`, section "2026-09-05 — Nadzór z powrotem do poprzedniego builda").
- [x] **[E013 — Signed Tauri release and PM3 deployment](epics/E013-2026-08-28-signed-tauri-pm3-deployment/PLAN.md)** — superseded 2026-09-06: docs/licensing/CI content absorbed by E017, release-rollback content absorbed by E014. No independent implementation needed; this entry stays only as a pointer for anyone who finds the old epic folder.
...
- [x] **[E012 — Analyst Dashboard](epics/E012-2026-05-16-analyst-dashboard/PLAN.md)** — separate Tauri window with Data Catalog (8 sources, schema + samples) and Explorer (5 charts over last 7 days). Mockup-first per ux-design-flow rule. Research: [reports/2026-05-16-data-sources.md](epics/E012-2026-05-16-analyst-dashboard/reports/2026-05-16-data-sources.md). Version bump to 0.5.0 in epic setup. Done, shipped as v0.5.0 (2026-05-16); its last 3 tasks (T09-T11 below) landed later under E018's numbering (2026-09-06).
